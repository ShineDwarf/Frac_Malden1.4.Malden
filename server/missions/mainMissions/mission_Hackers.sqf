...
private ["_positions", "_camonet", "_laptop", "_obj1", "_obj2", "_obj3", "_obj4", "_obj5", "_obj6", "_vehicleName","_table"];
...
_setupObjects =
{
	...
	_obj6 = createVehicle ["I_HMG_01_high_F", _missionPos,[], 10,"None"]; 
...
_successExec =
{
	...
	{ _x setVariable ["R3F_LOG_disabled", false, true] } forEach [_obj1, _obj2, _obj3, _obj4, _obj5, _obj6];
	{ _x setVariable ["allowDamage", true, true] } forEach [_obj1, _obj2, _obj3, _obj4, _obj5, _obj6];
